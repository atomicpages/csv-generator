...
(function () {
     ...
     * @param {{base: number}} [seq] Used for generating sequences across child processed.
     * @return {number|object} If `seq` is defined, return the same instance of the object.
     */
    faker.random.seq = function (seq) {
        if (seq) {
            seq.base++;
